...
(with-eval-after-load "company"
  (set-face-attribute 'company-tooltip-common nil :foreground "#2aa198" :background "#073642" :underline nil :bold t)
  (set-face-attribute 'company-tooltip-common-selection nil :foreground "#69CABF" :background "#00736F" :underline nil :bold t)
